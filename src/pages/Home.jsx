...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="card p-8 hover:shadow-2xl transition-all"
            >
              <div className="w-14 h-14 bg-[#dd212b]/10 rounded-xl flex items-center justify-center mb-6">
                <Clock className="w-7 h-7 text-[#dd212b]" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-[#dd212b]">Clear Events, Zero Confusion</h3>
              <p className="text-[#dd212b]/80 leading-relaxed">
            ...
            >
              <div className="w-14 h-14 bg-[#dd212b]/10 rounded-xl flex items-center justify-center mb-6">
                <Camera className="w-7 h-7 text-[#dd212b]" />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-[#dd212b]">All Wedding Photos, One Place</h3>
              <p className="text-[#dd212b]/80 leading-relaxed">
            ...
            return (
              ...
              >
                <div className="flex-shrink-0">
                  <div className="w-20 h-20 bg-[#dd212b] rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                    {step.step}
                  </div>
                </div>
      ...
      {/* Footer */}
      <footer className="bg-[#dd212b] text-white mt-24">
